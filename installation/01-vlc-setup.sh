...
echo "  sudo cp systemd/vlc-autoplay.service /etc/systemd/system/"
echo "  sudo systemctl daemon-reload"
echo "  sudo systemctl enable vlc-autoplay.service"
echo "  sudo systemctl start vlc-autoplay.service"
